...
import { fetchCatalog, updateLyrics, uploadTrack } from "./api";
    ...
    <div className="app-shell">
      ...
      <main>
        <header className="topbar">
          <div>
            <span className="context-label">{view === "library" ? "OpenChord Studio" : "Новый релиз"}</span>
            <h1>{view === "library" ? "Библиотека" : "Добавить музыку"}</h1>
          </div>
          {view === "library" && (
  ...
  return (
    <aside className="sidebar glass">
      ...
      <nav>
        ...
        <button className={view === "upload" ? "active" : ""} onClick={() => navigate("upload")}><Plus /> <span>Добавить</span></button>
      </nav>
